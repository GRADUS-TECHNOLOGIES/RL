        ...
        <div className='max-w-2xl mx-auto w-full p-3'>
            {currentUser ? (
                <div className="flex items-center gap-1 my-5 text-gray-500 text-sm">
                    <p>Inicio sesion como:</p>
                    <img className='h-5 w-5 object-cover rounded-full' src={currentUser.profilePicture} alt="" />
                    <Link to={'/dashboard?tab=profile'} className='text-xs text-[#b076ce] hover:underline'>
                ...
                <div className="text-sm text-black my-5 flex gap-1">
                    ...
                    <Link to={'/sign-in'} className='text-[#b076ce] hover:underline'>
                        Sign In
                    </Link>
                </div>
            )}
            ...
            {comments.length === 0 ? (
                <p className='text-sm my-5'>Sin comentarios aun...</p>
            ) : (
                <>
            ...
            <Modal
                ...
                <ModalBody>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Seguro que desea eliminar este comentario?</h3>
                        <div className='flex justify-center gap-10'>
                            <Button color='red' onClick={() => handleDelete(commentToDelete)}>Si, estoy seguro</Button>
