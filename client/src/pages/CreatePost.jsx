...
export default function CreatePost() {
    ...
    const uploadFile = (fileObj, accept, setProgress, setError, onSuccess) => {
    ...
    const handleUploadImage = () =>
        uploadFile(file, 'image/*', setImageUploadProgress, setImageUploadError, (url) =>
            setFormData((prev) => ({ ...prev, image: url }))
        );

    const handleUploadPdf = () =>
        uploadFile(pdfFile, 'application/pdf', setPdfUploadProgress, setPdfUploadError, (url) =>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) { setPublishError(data.message || 'Hubo un problema al publicar'); return; }
            setSuccessMessage('Publicación creada con éxito');
            setTimeout(() => navigate(`/post/${data.slug}`), 1500);
        } catch {
            setPublishError('No se pudo publicar la entrada');
        }
    };
        ...
        <div className="min-h-screen bg-white p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8 pb-6 border-b border-gray-100">
                    ...
                    <h1 className="text-3xl md:text-4xl font-black text-gray-900">Crear publicación</h1>
                    <p className="text-sm text-gray-400 font-light mt-1">
                        Redacta un artículo o carga una revista con vista previa en tiempo real
                    </p>
                </div>
                ...
                <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="text-xs text-gray-400 font-light">
                            {isMagazineMode
                                ? 'Modo revista: sube un PDF. El visor lo renderizará página por página.'
                                : 'Modo artículo: escribe el contenido en el editor y sube una imagen de portada.'}
                        </p>
                    </div>
                            ...
                            <div className="border border-gray-100 flex flex-col overflow-hidden">
                                ...
                                <div className="p-5 border-b border-gray-100 flex-shrink-0">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        >
                                            {imageUploadProgress ? `${imageUploadProgress}%` : 'Cargar'}
                                        </button>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: sanitizeHtml(formData.content) ||
                                                '<p style="color:#d1d5db;font-size:0.875rem;font-weight:300">El contenido aparecerá aquí mientras escribes...</p>',
                                        }}
                                    />
                                </div>
                            </div>
                    ...
                    {isMagazineMode && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            {/* Panel: Upload PDF */}
                            <div className="border border-gray-100 flex flex-col overflow-hidden">
                                <PanelHeader label="Cargar PDF" purple />
                                ...
                                <div className="p-6 flex flex-col gap-4">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 border border-gray-900 text-[10px] font-black text-gray-900 uppercase tracking-[0.15em] hover:bg-[#B076CE] hover:border-[#B076CE] hover:text-white disabled:opacity-40 disabled:cursor-not-allowed transition-all whitespace-nowrap"
                                        >
                                            {pdfUploadProgress ? `${pdfUploadProgress}%` : 'Cargar'}
                                        </button>
                                    </div>
                                    ...
                                    <div className="border border-gray-100 p-4 mt-2">
                                        ...
                                        <ul className="text-xs text-gray-400 font-light space-y-1 leading-relaxed list-none">
                                            ...
                                            <li>El PDF se renderizará página por página en el visor.</li>
                                            <li>Asegúrate de que el PDF esté finalizado antes de cargarlo.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
