...
import { verifyToken, attachUserIfPresent } from '../utils/verifyUser.js';
...
router.get('/getposts', attachUserIfPresent, getposts);     // Pública, pero si hay un admin autenticado también ve posts programados a futuro
